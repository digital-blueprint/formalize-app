            ...
            <form id="ethics-commission-form">
                ...
                <dbp-form-enum-element
                    ...
                    .items=${{
                        ...
                        "no-publication": i18n.t('render-form.forms.ethics-commission-form.no-publikation-label'),
                        "one-publication": i18n.t('render-form.forms.ethics-commission-form.one-publikation-label'),
                    }}
...
3) Angaben zum Projektvolumen bzw. zur Höhe der Finanzierung"
                ...
                <dbp-form-enum-element
                    @change="${(e) => {
                        if (e.detail.value) {
                            this.humanTestSubjectsQuestionsEnabled = e.detail.value === 'yes' ? true : false;
                        }
                    }}"
                    subscribe="lang"
                    name="test-subjects"
                ...
                ${this.humanTestSubjectsQuestionsEnabled ?
                    html`
                        <div class="question-group ${classMap({ 'fade-in': this.humanTestSubjectsQuestionsEnabled})}">
                            <h4 class="question-group-title">1.1. Menschen als Proband*innen im Forschungsvorhaben</h4>
                        ...
                        <div class="question-group">
                            <h4 class="question-group-title">1.2. Physische oder psychische Eingriffe an Proband*innen</h4>
                        ...
                        <div class="question-group">
                            <h4 class="question-group-title">1.3. Zumutbarkeit des Forschungsvorhabens</h4>
                            <dbp-form-enum-element
                                subscribe="lang"
                ...
                <dbp-form-enum-element
                    @change="${(e) => {
                        if (e.detail.value) {
                            this.humanStemCellsQuestionsEnabled = e.detail.value === 'yes' ? true : false;
                        }
                    }}"
                    subscribe="lang"
                ...
                ${this.humanStemCellsQuestionsEnabled ?
                    html`
                        <div class="question-group ${classMap({ 'fade-in': this.humanStemCellsQuestionsEnabled})}">
                            <h4 class="question-group-title">2.1. Art des Forschungsmaterials</h4>
                            <!-- ITT TARTOK-->
                            <dbp-form-enum-element
                                subscribe="lang"
                            ...
                            <dbp-form-enum-element
                                @change="${(e) => {
                                    if (e.detail.value) {
                                        this.stemCellFromEmbryosQuestionsEnabled = e.detail.value === 'yes' ? true : false;
                                    }
                                }}"
                                subscribe="lang"
                            ...
                            ${this.stemCellFromEmbryosQuestionsEnabled ?
                                html`
                                    <dbp-form-enum-element
                                        class="${classMap({ 'fade-in': this.stemCellFromEmbryosQuestionsEnabled})}"
                                        subscribe="lang"
                            ...
                            <dbp-form-enum-element
                                @change="${(e) => {
                                    if (e.detail.value) {
                                        this.stemCellFromHumanEmbryosQuestionsEnabled = e.detail.value === 'yes' ? true : false;
                                    }
                                }}"
                                subscribe="lang"
                            ...
                            ${this.stemCellFromHumanEmbryosQuestionsEnabled ?
                                html`
                                    <dbp-form-enum-element
                                        class="${classMap({ 'fade-in': this.stemCellFromHumanEmbryosQuestionsEnabled})}"
                                        subscribe="lang"
                                        name="stem-cells-from-embryos"
                                        display-mode="list"
                                        required
                        ...
                        <div class="question-group">
                            <h4 class="question-group-title">2.2. Herkunft des Forschungsmaterials</h4>
                            ...
                            <dbp-form-enum-element
                                @change="${(e) => {
                                    if (e.detail.value) {
                                        this.cellsObtainedInResearchQuestionsEnabled = e.detail.value === 'yes' ? true : false;
                                    }
                                }}"
                                subscribe="lang"
                            ...
                            ${!this.cellsObtainedInResearchQuestionsEnabled ?
                                html`
                                    <dbp-form-string-element
                                        class="${classMap({ 'fade-in': this.cellsObtainedInResearchQuestionsEnabled})}"
                                        subscribe="lang"
                ...
                ${this.animalQuestionsEnabled ?
                    html`
                        <div class="question-group ${classMap({ 'fade-in': this.animalQuestionsEnabled})}">
                            <h4 class="question-group-title">3.1. Tiere im Forschungsvorhaben</h4>
                            vertebrates
                            <dbp-form-enum-element
                                subscribe="lang"
                ...
                <dbp-form-enum-element
                    @change="${(e) => {
                        if (e.detail.value) {
                            this.nonEuCountriesQuestionsEnabled = e.detail.value === 'yes' ? true : false;
                        }
                    }}"
                    subscribe="lang"
                ...
                ${this.nonEuCountriesQuestionsEnabled ?
                    html`
                        <div class="question-group ${classMap({ 'fade-in': this.nonEuCountriesQuestionsEnabled})}">
                            <h4 class="question-group-title">4.1.	Forschungsvorhaben außerhalb der EU bzw. in Drittstaaten</h4>
                            ...
                            <dbp-form-enum-element
                                @change="${(e) => {
                                    if (e.detail.value) {
                                        this.questionResearchFoundsQuestionsEnabled = e.detail.value === 'yes' ? true : false;
                                    }
                                }}"
                                subscribe="lang"
                            ...
                            ${this.questionResearchFoundsQuestionsEnabled ?
                                html`
                                    <dbp-form-enum-element
                                        class="${classMap({ 'fade-in': this.questionResearchFoundsQuestionsEnabled})}"
                                        subscribe="lang"
                ...
                <h3 class="section-sub-title">5. Nachhaltigkeit, Gesundheit und Sicherheit</h3>
                    ...
                    <dbp-form-enum-element
                        @change="${(e) => {
                            if (e.detail.value) {
                                this.harmfulSubstancesOnSubjects = e.detail.value === 'yes' ? true : false;
                            }
                        }}"
                        subscribe="lang"
                    ...
                    ${this.harmfulSubstancesOnSubjects ?
                        html`
                            <dbp-form-enum-element
                                class="${classMap({ 'fade-in': this.harmfulSubstancesOnSubjects})}"
                                subscribe="lang"
                ...
                <div class="question-group ${classMap({ 'fade-in': this.nonEuCountriesQuestionsEnabled})}">
                    ...
                    <dbp-form-enum-element
                        @change="${(e) => {
                            if (e.detail.value) {
                                this.ethicalIssuesListQuestion = e.detail.value === 'yes' ? true : false;
                            }
                        }}"
                        subscribe="lang"
                    ...
                    ${this.ethicalIssuesListQuestion ?
                        html`
                            <dbp-form-string-element
                                class="${classMap({ 'fade-in': this.ethicalIssuesListQuestion})}"
                                subscribe="lang"
                ...
                <dbp-form-enum-element
                    @change="${(e) => {
                        if (e.detail.value) {
                            this.hasConflictOfInterestSubQuestion = e.detail.value === 'yes' ? true : false;
                        }
                    }}"
                    subscribe="lang"
                ...
                ${this.hasConflictOfInterestSubQuestion ?
                    html`
                        <dbp-form-string-element
                            class="${classMap({ 'fade-in': this.hasConflictOfInterestSubQuestion})}"
                            subscribe="lang"
                ...
                <dbp-form-enum-element
                    @change="${(e) => {
                        if (e.detail.value) {
                            this.hasConfidentialPartSubQuestion = e.detail.value === 'yes' ? true : false;
                        }
                    }}"
                    subscribe="lang"
                ...
                ${this.hasConfidentialPartSubQuestion ?
                    html`
                        <dbp-form-string-element
                            class="${classMap({ 'fade-in': this.hasConfidentialPartSubQuestion})}"
                            subscribe="lang"
                ...
                <dbp-form-enum-element
                    @change="${(e) => {
                        if (e.detail.value) {
                            this.hasConflictInContentControlSubQuestion = e.detail.value === 'yes' ? true : false;
                        }
                    }}"
                    subscribe="lang"
                ...
                ${this.hasConflictInContentControlSubQuestion ?
                    html`
                        <dbp-form-string-element
                            class="${classMap({ 'fade-in': this.hasConflictInContentControlSubQuestion})}"
                            subscribe="lang"
                ...
                <dbp-form-enum-element
                    @change="${(e) => {
                        if (e.detail.value) {
                            this.stakeholderParticipationPlannedSubQuestion = e.detail.value === 'yes' ? true : false;
                        }
                    }}"
                    subscribe="lang"
                ...
                ${this.stakeholderParticipationPlannedSubQuestion ?
                    html`
                        <dbp-form-enum-element
                            class="${classMap({ 'fade-in': this.stakeholderParticipationPlannedSubQuestion})}"
                            subscribe="lang"
