...
export class CourseSelect extends ScopedElementsMixin(AdapterLitElement) {
    constructor() {
        super();
        Object.assign(CourseSelect.prototype, errorUtils.errorMixin);
        this.auth = {};
        ...
        this.selectId = 'course-select-' + commonUtils.makeId(24);
        this.value = '';
        this.object = null;
    ...
    initSelect2(ignorePreset = false) {
        ...
        const apiUrl = combineURLs(this.entryPointUrl, '/base/courses');
